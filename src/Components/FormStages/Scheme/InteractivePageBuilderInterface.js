                      ...
                      {isEditing[index] ? (
                        ...
                        >
                          ...
                          <div>
                            ...
                            <HexColorPicker
  style={{padding: '20px',paddingTop: '0px',marginLeft: "auto", marginRight: "auto"}}
  id="buttoncolor"
                ...
                formField = (
                  <div style={parentStyle}>
                    {isEditing[index] ? (
                      ...
                      <div key={index}>
                        <TextArea
                          style={{width: componentWidths[index]  + "px", height: componentHeights[index] + "px"}}
                          input={{
                            type: field.type,
                            name: field.label,
                            required: field.required,
...
/>
                    ...
                    <div key={index}>
                      <label
                        style={{color: componentColors[index], fontSize: selectedFontSize[index]}}
                        input={{
                          type: "text",
...
/>
                              ...
                              <select
                               ...
                               onChange={(event) => handleSelectChange(event.target.value, index)}
                              >
